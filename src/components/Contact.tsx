...
export function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_aodj25d", // your EmailJS Service ID
        "template_1wz0mxp", // your EmailJS Template ID
        formRef.current,
        "Iluba-mXUKczsUJGq" // your EmailJS Public Key
      )
      .then(
        () => {
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Whether you're looking for a frontend developer to join your
                team, need consultation on your project, or just want to discuss
